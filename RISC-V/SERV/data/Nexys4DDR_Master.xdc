...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { wb_clk }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets wb_eluks_inst/eluks_inst/fsm/r_state_prev/r_block_prev_i_1];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets wb_eluks_inst/eluks_inst/fsm/r_state_prev/r_block_prev_i_2];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets wb_eluks_inst/eluks_inst/fsm/r_state_prev/spi_r_block];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets wb_eluks_inst/spi_inst/dout[0]_i_4__1];
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets wb_eluks_inst/spi_inst/counter_wait/dout[0]_i_5];
